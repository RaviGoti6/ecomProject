...
class Vendor(models.Model):
    ...
    image = models.ImageField(upload_to=user_directory_path, default="vender.jpg")
    description = models.TextField(null=True, blank=True, default="Vender Description")
...
############################################### Cart, Order, OrderItmes and Address ################################################
############################################### Cart, Order, OrderItmes and Address ################################################
############################################### Cart, Order, OrderItmes and Address ################################################
